...
<section class="max-w-5xl mx-auto p-2">
    <div class="flex gap-2 items-center justify-between">
        <h2 class="text-3xl font-bold text-textPrimary mb-6">Profile</h2>
        <div>
            <a href="<?= App::currentPath() . '/edit' ?>" class="!bg-accent mx-1 !text-bg rounded-lg hover:bg-accent/90 transition text-sm px-2 py-2 font-medium">
                <i class="ri-edit-line text-lg !text-bg mr-1"></i>
            </a>
            ...
            <div class="w-full md:w-3/5 grid grid-cols-2 gap-4">
                ...
                <div>
                    ...
                    <div class="flex space-x-1 mt-1">
                        ...
                        <?php
                        endforeach;
                        echo '<div class="pl-2">' . App::icon('edit', App::parentPath() . '/theme') . '</div>';
                        ?>
                    </div>
                </div>
                ...
                <div>
                    ...
                    <p class="text-textPrimary font-medium text-sm"><?= $user['preferences']['entries_per_page'] ?? 'Not Set!'; ?>
                        <span class="pl-2"><?= App::icon('edit', App::parentPath()); ?></span>
                    </p>
                </div>
            </div>
